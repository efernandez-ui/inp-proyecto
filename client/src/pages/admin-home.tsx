...
const sidebarGroups = [
  ...
  },
  {
    title: "ADMIN",
    items: [
      { label: "PANEL ADMIN", icon: Grid2X2 },
...
const modules = [
  ...
  {
    title: "Panel admin",
    text: "Panel principal de administracion.",
    icon: Grid2X2,
  },
  {
    title: "Parametros",
...
export default function AdminHome() {
  return (
    <div className="min-h-screen bg-white pt-14 text-intercap-blue-dark">
      <Header mode="admin" />
        ...
        <div className="flex w-full">
          ...
          <section className="min-h-[720px] flex-1 px-5 py-6 md:px-8">
            <div className="bg-white px-6 py-6 shadow-sm">
              ...
              <h1 className="mt-2 text-3xl font-black">¡Bienvenido, ADMIN!</h1>
