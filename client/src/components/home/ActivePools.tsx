      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-xl overflow-hidden shadow-xl flex flex-col text-gray-800 transform hover:-translate-y-2 transition-transform duration-300">
            <div className="h-32 bg-gray-100 relative flex items-center justify-center border-b border-gray-200 p-4">
              <span className="absolute top-3 right-3 bg-red-100 text-red-600 text-xs font-bold px-2 py-1 rounded flex items-center gap-1">
                <Clock className="w-3 h-3" /> Termina pronto
              </span>
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/NGK_logo.svg/512px-NGK_logo.svg.png" alt="NGK" className="max-h-full max-w-full object-contain" />
            </div>
          ...
          <div className="bg-white rounded-xl overflow-hidden shadow-xl flex flex-col text-gray-800 transform hover:-translate-y-2 transition-transform duration-300">
            <div className="h-32 bg-gray-100 relative flex items-center justify-center border-b border-gray-200 p-4">
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/Motul_logo.svg/512px-Motul_logo.svg.png" alt="Motul" className="max-h-full max-w-full object-contain" />
            </div>
            <div className="p-5 flex-1 flex flex-col">
          ...
          <div className="bg-white rounded-xl overflow-hidden shadow-xl flex flex-col text-gray-800 transform hover:-translate-y-2 transition-transform duration-300">
            <div className="h-32 bg-gray-100 relative flex items-center justify-center border-b border-gray-200 p-4">
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Yuasa_Battery_logo.svg/512px-Yuasa_Battery_logo.svg.png" alt="Yuasa" className="max-h-full max-w-full object-contain" />
            </div>
            <div className="p-5 flex-1 flex flex-col">
              <h4 className="font-bold text-lg leading-tight mb-2">Baterías Yuasa</h4>
